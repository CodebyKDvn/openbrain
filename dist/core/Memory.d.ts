...
export type Memory = EpisodicMemory | SemanticMemory | ProceduralMemory | DecisionMemory | BugMemory | WorkspaceMemory | ProjectMemory;
export declare function createMemory<T extends MemoryBase>(type: MemoryType, content: string, metadata: T['metadata'], tags?: string[], confidence?: number): T;
